...
from lipsync.dinet_lp_static.model import DINetSPADE
...
class DINetClipLightningModule(L.LightningModule):
    ...
    def training_step(self, batch, batch_idx):
        ...
        _, pred_fake_lip_dI = self.lip_net_dI(fake_out)
        loss = {}
...
if __name__ == "__main__":
    ...
    from lipsync.dinet_lp_static.ds import load_concat_data
