...
pretrained_frame_DINet_path = "weights/v5_lp/epoch=24-step=174525-val_ep_loss=1.747-train_ep_loss=2.302-val_ep_sync_loss=0.405-train_ep_sync_loss=0.469.ckpt"
