data = [
    ...
    dict(
        data_root="/data/prakash_lipsync",
        train_json="/data/prakash_lipsync/v1/iv_recording_v2/train_hallo_512_lm.json",
        val_json="/data/prakash_lipsync/v1/iv_recording_v2/val_hallo_512_lm.json",
...
pretrained_frame_DINet_path = "weights/v1_512/epoch=14-step=127980-val_ep_loss=1.272-train_ep_loss=1.292-val_ep_sync_loss=0.199-train_ep_sync_loss=0.141.ckpt"  # "weights/v4_512/epoch=125-step=477792-val_ep_loss=2.147-train_ep_loss=2.897-val_ep_sync_loss=0.164-train_ep_sync_loss=0.136.ckpt"
