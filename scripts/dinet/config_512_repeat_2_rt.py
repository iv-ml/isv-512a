...
data = [
    dict(
        ...
        silences=True,
        reference_frames_transforms=True,
    ),
    dict(
        data_root="/data/prakash_lipsync",
...
pretrained_frame_DINet_path = "weights/v6_v2_repeat/epoch=100-step=143622-val_ep_loss=1.144-train_ep_loss=1.164-val_ep_sync_loss=0.121-train_ep_sync_loss=0.143.ckpt"
