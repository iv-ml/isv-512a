...
class ClipDataset(Dataset):
    def __init__(
        ...
        self.video_folder_lp = video_folder_lp
    ...
    def __getitem__(self, index):
        ...
        for source_frame_index in range(start_frame, 5):
            ...
            reference_anchor_list = random.sample(available_indices, 4)

            ref_1_loc = (
                self.data_root
                / self.video_folder_lp
                / self.ds_name
                / video_name
                / source_image_path_list["folder_name"]
                / source_image_path_list["images"][source_frame_index]
            )
            ref_1_image_data = torchvision.io.read_image(ref_1_loc, mode=torchvision.io.ImageReadMode.RGB)
            reference_frame_list.append(ref_1_image_data)
...
def load_concat_data(opt):
    train_data = [
        ClipDataset(
            ...
            video_folder_lp=d.video_folder_lp,
...
if __name__ == "__main__":
    ...
    x2.save("temp/source_lp_static.png")
    ...
    x1.save("temp/references_lp_static.png")
    # breakpoint()
